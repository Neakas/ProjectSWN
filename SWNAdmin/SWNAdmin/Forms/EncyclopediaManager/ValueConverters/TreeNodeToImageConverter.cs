...
namespace SWNAdmin.Forms.EncyclopediaManager.ValueConverters
{
    ...
    public class TreeNodeToImageConverter : IValueConverter
    {
        ...
        private static readonly IDictionary<string, ImageSource> SuffixToImageMap =
            new Dictionary<string, ImageSource>();

        private static readonly ImageSource FolderSource =
            new BitmapImage(new Uri(string.Format(UriFormat, "Folder.png")));
        ...
        static TreeNodeToImageConverter()
        {
            ...
            SuffixToImageMap[".png"] =
                SuffixToImageMap[".jpeg"] =
                    SuffixToImageMap[".jpg"] = new BitmapImage(new Uri(string.Format(UriFormat, "Picture.png")));
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            if (!viewModel.IsLeaf)
                return FolderSource;
            var source =
                SuffixToImageMap.Where(kvp => viewModel.Name.EndsWith(kvp.Key))
